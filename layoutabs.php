            ...
            <div class="collapse navbar-collapse" id="navbarColor01">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link" href="findAllPA.php"  id="n"><i class="fas fa-users" id="n"></i> <b >Liste des demandes d'absences </b></a>
                    </li>
                    <li class="nav-item">

<a class="nav-link" href="liste_demande_En_Attente.php"  id="n"><i class="fas fa-users" id="n"></i> <b >Liste d'attente </b></a>
</li>
                    <li class="nav-item">
                        <a class="nav-link" href="addPA.php"  id="n"><i class="fas fa-user-plus" id="n"></i><b> Ajout d'un nouvel demande</b></a>
                    </li>
                    <li class="nav-item">
...
if(isset($_GET['ok'])){
    ...
    header("location:findPA.php?matricule=".$matricule);}
