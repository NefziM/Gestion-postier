            ...
            <div class="collapse navbar-collapse" id="navbarColor01">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link" href="findAllP.php"  id="n"><i class="fas fa-users" id="n"></i> <b >Liste des postiers </b></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="addP.php"  id="n"><i class="fas fa-user-plus" id="n"></i><b> Ajout d'un nouvel postier</b></a>
                    </li>
                    <li class="nav-item">
...
<button type="submit" name="ok" id="button" class="btn btn-outline-secondary"><i class="fas fa-search" id="n"></i></button></div>
</form></fieldset>
<?php
...
if(isset($_GET['ok'])){
    ...
    header("location:findP.php?matricule=".$matricule);}
